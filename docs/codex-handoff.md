...
**Binary:** `build/c-tail-poc/waste-wast`  
...
build/c-tail-poc/waste-wast /home/a/Work/waste/submodules/wasm-spec/test/core/call.wast
...
for path in sorted(glob.glob('/home/a/Work/waste/submodules/wasm-spec/test/core/*.wast') + 
    ...
    try:
        r = subprocess.run(['/home/a/Work/waste/build/c-tail-poc/waste-wast', path],
