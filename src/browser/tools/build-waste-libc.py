...
def main() -> None:
    ...
    source_path = root / "src" / "browser" / "lib-impl" / "waste-libc.wat"
    ...
    with tempfile.TemporaryDirectory(dir=output_path.parent) as temporary_name:
        ...
        subprocess.run(
            [
                ...
                str(root / "src" / "browser" / "lib-impl" / "waste-libc-helpers.c"),
                str(root / "src" / "browser" / "lib-impl" / "waste-libc-extra.c"),
    ...
    for client_path in sorted(client_root.glob("*-client.wast.inc")):
        ...
        fixture = (
            ";; Generated by src/browser/tools/build-waste-libc.py; do not edit.\n"
